...
if(isset($_POST['submit']))
{
    ...
    $query=mysqli_query($con,"INSERT INTO  tbladmin (AdminNAme,UserName,MobileNumber,Email,Password)VALUES('$admin','$user','$phone','$email','$password')");
    if($query){
...
<head>
    ...
    <title>Sign-Up - Windmill Dashboard</title>
    <link
